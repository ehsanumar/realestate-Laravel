    ...
    <div class="container">
        <div class="row mb-5 align-items-center">
            ...
            <div class="col-lg-6 text-lg-end">
                <p>
                    <a href="{{ route('all') }}" class="btn btn-primary text-white py-3 px-4">View all
                        properties</a>
                </p>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="property-slider-wrap">
                    <div class="property-slider">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 " style="margin-bottom: 50px; ">
                                <div class="property-item "
                                    ...
                                    <a href="property-single.html" class="img">
                                        <img src="{{ $estate->media[0]->getUrl() }}" alt="Image"
                                            class="img-fluid"
                                    ...
                                    <div class="property-content">
                                        ...
                                        <div>
                                            ...
                                            <div class="specs d-flex mb-4 px-2 gap-2 ">
                                                <span class="d-block border-end ">
                                                    <span class="icon-bed me-2"></span>
                                                    <span class="caption d-flex me-2 ">{{ $estate->number_of_bedroom }}
                                                        <span class="me-1">Bed</span></span>
                                                </span>
                                                <span class="d-block border-end ml-1 ">
                                                    <span class="icon-bath me-2"></span>
                                                    <span class="caption d-flex ">{{ $estate->number_of_bathroom }}
                                                        <span class="me-1">Bath</span></span>
                                                </span>

                                                <span class="d-block border-end ml-1 ">
                                                    <span class="icon-kitchen me-2"></span>
                                                    <span class="caption d-flex">{{ $estate->number_of_kitchen }} <span
                                                            class="me-1">Kitchen</span></span>
                                                </span>
                                                <span class="d-block border-end ml-1 ">
                                                    <span class="icon-building me-2  "></span>
                                                    <span class="caption d-flex">{{ $estate->number_of_floor }} <span
                                                            class="me-1">Floor</span></span>
                                                </span>
                                                <span class="d-block  me-1 ">
                                                    <span class="icon-car me-2"></span>
                                                    <span class="caption d-flex">{{ $estate->number_of_garage }} <span
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <form
                                                    action="{{ route('favourite.store', ['favourite' => $estate->id]) }}"
                                                    method="POST">
                        ...
                        <div id="property-nav" hiddenپ class="controls" tabindex="0" aria-label="Carousel Navigation">
                            <span data-controls="prev" aria-controls="property" tabindex="-1"></span>
                            <span data-controls="next" aria-controls="property" tabindex="-1"></span>
                        </div>
